		...
		<div class="panel-heading">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
              ...
              <div class="col-md-8"><br>
                            <a id="boton2"  href="pdf/pdf_Usuarios/"  class="w3-button w3-white w3-border">Reporte PDF</a>
                        </div>
					</div>
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			$("#mod_id").val(id);
			$("#PrimerNombre2").val(nombres);
			$("#Apellido2").val(apellidos);
			$("#Usuario2").val(usuario);
			$("#Email2").val(email);
			$("#user_Rol2").val(Rol);
			$("#user_Ciudad2").val(Ciudad);
