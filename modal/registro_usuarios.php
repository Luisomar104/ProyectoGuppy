		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
	  		...
	  		<div class="form-group">
				<label for="user_id" class="col-sm-3 control-label">Cedula de Ciudadania</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="user_id" name="user_id" placeholder="Nombres" required>
				</div>
			  </div>


			  <div class="form-group">
				<label for="PrimerNombre" class="col-sm-3 control-label">Nombres</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="PrimerNombre" name="PrimerNombre" placeholder="Nombres" required>
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="Usuario" name="Usuario" placeholder="Usuario" pattern="[a-zA-Z0-9]{2,64}" title="Nombre de usuario ( sólo letras y números, 2-64 caracteres)" required>
				</div>
			  </div>
			  <div class="form-group">
