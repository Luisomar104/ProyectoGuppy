		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				  ...
				  <div class="col-sm-8">
				  <select name="mod_TipoProducto"  class="form-control" required>
			                <option value="">Tipo Producto...</option>
			                <?php
			                    foreach ($con->query('SELECT * from tipoproducto') as $row) {
			                        echo '<option value="' . $row['IdTipoProducto'] . '">' . $row['DescripcionTipoProducto'] . '</option>';;                        
			                    }
			                ?>
			        </select>	
			       </div>
		    	...
		    	<div class="form-group">
				  ...
				  <div class="col-sm-8">
				  <select name="mod_TamPresentacion"  class="form-control" required>
			                <option value="">Tamaño...</option>
			                <?php
			                    foreach ($con->query('SELECT * from tampresentacion') as $row) {
			                        echo '<option value="' . $row['IdTamPresentacion'] . '">' . $row['DescripcionTP'] . '</option>';;                        
			                    }
			                ?>
			        </select>	
			       </div>
