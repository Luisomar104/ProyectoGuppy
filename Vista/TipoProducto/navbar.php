...
<nav class="navbar navbar-default ">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <li><a href="index.php"><i class='glyphicon glyphicon-barcode'></i> Tipo Productos</a></li> 
    ...
    <li><a href="../Rol/rolVista.php"><i  class='glyphicon glyphicon-dashboard'></i> Rol</a></li>
