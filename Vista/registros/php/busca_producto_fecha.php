...
$registro = mysqli_query($conexion,"SELECT facturas.*,clientes.nombre_cliente,users.PrimerNombre from facturas join clientes on facturas.id_cliente=clientes.id_cliente join users on users.user_id=facturas.id_vendedor WHERE fecha_factura BETWEEN '$desde' AND '$hasta' ORDER BY id_factura ASC");
