...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Le GUPPY.</a>
    </div>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <li><a href="Vista/TipoProducto/index.php"><i class='glyphicon glyphicon-barcode'></i> Tipo Productos</a></li> 
    ...
    <li><a href="Vista/Rol/rolVista.php"><i  class='glyphicon glyphicon-dashboard'></i> Rol</a></li>
