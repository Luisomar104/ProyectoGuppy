                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-condensed">
                    <tbody>
					  ...
					  <tr>
                        <td><input style="display: none;" value="0.1" type="text" class="form-control input-sm" required name="impuesto" value="<?php echo $row['impuesto']?>"></td>
                      </tr>
					  <tr>
                        <td>Simbolo de moneda:</td>
                        <td><input type="text" class="form-control input-sm" required name="moneda" value="<?php echo $row['moneda']?>"></td>
					  <tr>
                        <td>Dirección:</td>
