...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "Restaurente Le Guppy. "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:50%;" class='midnight-blue'>Recibo para:</td>
        </tr>
		<tr>
           <td style="width:50%;" >
			<?php 
		...
		<tr>
           <td style="width:35%;">
			<?php 
				...
				echo $rw_user['PrimerNombre']." ".$rw_user['Apellido'];
			?>
		   </td>
...
?>
		...
		<tr>
            <td style="display: none;" colspan="3" style="widtd: 85%; text-align: right;">IVA (<?php echo $impuesto; ?>)% <?php echo $simbolo_moneda;?> </td>
            <td style="display: none;" style="widtd: 15%; text-align: right;"> <?php echo number_format($total_iva,2);?></td>
        </tr><tr>
