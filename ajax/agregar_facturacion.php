...
<tr>
	<td style="display: none;" class='text-right' colspan=4>IVA (<?php echo $impuesto;?>)% <?php echo $simbolo_moneda;?></td>
	<td style="display: none;" class='text-right'><?php echo number_format($total_iva,2);?></td>
	<td></td>
</tr>
<tr>
