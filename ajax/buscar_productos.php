<?php
	...
	if($action == 'ajax'){
		...
		$sql="SELECT products.*, tampresentacion.DescripcionTP, tipoproducto.DescripcionTipoProducto from tampresentacion join products on (products.TamPresentacion=tampresentacion.IdTamPresentacion) join tipoproducto on (tipoproducto.IdTipoProducto=products.TipoProducto) LIMIT $offset,$per_page";
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$TipoProducto=$row['DescripcionTipoProducto'];
						$TamPresentacion=$row['DescripcionTP'];
					?>
					...
					<input type="hidden" value="<?php echo $estado_producto;?>" id="estado<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo number_format($precio_producto,2,'.','');?>" id="precio_producto<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $TipoProducto;?>" id="TipoProducto<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $TamPresentacion;?>" id="TamPresentacion<?php echo $id_producto;?>">
					<tr>
						...
						<td><?php echo $TamPresentacion;?></td>
