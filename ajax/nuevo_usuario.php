...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
        ...
        if (empty($_POST['user_id'])){
            $errors[] = "user_id vacía";
        }elseif (empty($_POST['PrimerNombre'])){
            ...
            $errors[] = "Ciudad vacías";        

        } elseif (
			!empty($_POST['Usuario'])
            && !empty($_POST['user_id'])
			&& !empty($_POST['PrimerNombre'])
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $PrimerNombre = mysqli_real_escape_string($con,(strip_tags($_POST["PrimerNombre"],ENT_QUOTES)));
                ...
                $sql = "SELECT * FROM users WHERE Usuario = '" . $Usuario . "' OR Email = '" . $Email . "';";
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (user_id,PrimerNombre, Apellido, Usuario, Password, Email, Fecha, Rol, Ciudad)
                            VALUES('".$user_id."','".$PrimerNombre."','".$Apellido."','" . $Usuario . "', '" . $Password . "', '" . $Email . "','" .$Fecha."','" . $Rol . "','" . $Ciudad . "');";
