<?php
	...
	if($action == 'ajax'){
		// escapando, eliminando adicionalmente todo lo que podría ser código (html / javascript-)
		...
		$per_page = 7; //	cuantos registros quieres mostrar
		$adjacents  = 6; //espacio entre páginas después del número de adyacentes
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					$TamPresentacion=$row["TamPresentacion"];
					?>
					<tr>
						...
						<input class="form-control" style="text-align:right" id="cantidad_<?php echo $id_producto; ?>"  value="1" type="number"  min="1" max="99">
						</div></td>
