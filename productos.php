		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
			 ...
			 <div class="col-md-8"><br>
                            <a id="boton2"  href="pdf/pdf_productos"  class="w3-button w3-white w3-border">Reporte PDF</a>
                        </div>
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var TipoProducto = $("#TipoProducto"+id).val();
			var TamPresentacion = $("#TamPresentacion"+id).val();
			$("#mod_id").val(id);
			$("#mod_codigo").val(codigo_producto);
			$("#mod_nombre").val(nombre_producto);
			$("#mod_precio").val(precio_producto);
			$("#mod_estado").val(estado);
			$("#mod_TipoProducto").val(TipoProducto);
			$("#mod_TamPresentacion").val(TamPresentacion);
		}
</script>